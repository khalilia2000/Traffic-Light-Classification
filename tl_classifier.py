...
class TLClassifier(object):
    ...
    def slide_imgs(self, image, normalize=True):
    ...
    def verbose_classification(self, filename):
        '''
        get classification and show the image
        '''
        print()
        print('==========')
        print(filename)
        ...
        pyplot.imshow(image)
        print(self.get_classification(image))
